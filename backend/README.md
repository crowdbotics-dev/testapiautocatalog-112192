...
## Project Structure
    ...
    ├── testapiautocatalog_112192  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112192`
...
2. Clone this repo and `cd testapiautocatalog_112192`
